...
const SelectDataComponent = () => {
  ...
  const handleSelection = (param) => {
    // navigate("/load_data", { state: { param } }); //Old
    navigate("/builder_chart");
  };
    ...
    <div className="">
      ...
      >
        <div className="rounded-lg shadow-xl cursor-grab">
          ...
          />
          <button
            className=" button image-label p-2  h-[80px] text-white font-thin"
        ...
        <div className="rounded-lg shadow-xl cursor-grab">
          ...
          />
          <button
            className="button image-label h-[80px] p-2 text-[10px] text-white font-thin"
        ...
        <div className="rounded-lg shadow-xl cursor-grab">
          ...
          />
          <button
            className="button image-label p-2 h-[80px] text-[10px] text-white font-thin"
            onClick={() => handleSelection(3)}
          >
