      ...
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
          <h1 className="text-start  max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">
            Créez votre profil RPG dans une expérience unique!
          </h1>
          ...
          <div className=" max-w-2xl mb-6 flex items-center">
            <img
              className="h-12 w-12 rounded-3xl relative border-[3px] dark:border-gray-900 border-white  mr-[-8px]"
              src="https://picsum.photos/seed/picsum/200/300"
              alt="profils users"
            />
            <img
              className="h-12 w-12 rounded-3xl relative border-[3px] dark:border-gray-900 border-white mr-[-8px] left-[-1px]"
            ...
            />
            <img
              className="h-12 w-12 rounded-3xl relative border-[3px] dark:border-gray-900 border-white mr-3"
